#!/usr/bin/env python3
"""Task 5: Least Used caching module.
"""
...
class LFUCache(BaseCaching):
    ...
    retrieving items from dictionary with a LFU
    removal mechanism when limit has been reached.
    """
    def __init__(self):
    ...
    def __reorder_items(self, mru_key):
        """Reorders items in this cache based on the most
        recently used.
        """
        max_positions = []
        mru_freq = 0
